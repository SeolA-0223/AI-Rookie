...
const KO_COPY = {
  ...
  source: {
    ...
    searchHint: "조례명 일부 키워드를 2글자 이상 입력하면 자동으로 후보를 찾고, 아래 지자체 선택과 함께 범위를 좁힙니다.",
  ...
  messages: {
    ...
    sourceSearchReady: (scope) => `${scope} 범위에서 조례명을 입력하면 자동으로 후보를 찾습니다. 필요하면 before/after ID도 직접 입력할 수 있습니다.`,
...
const EN_COPY = {
  ...
  source: {
    ...
    searchHint: "Type at least two keyword characters from an ordinance title to auto-search, then narrow the same search with the municipality filters below.",
  ...
  messages: {
    ...
    sourceSearchReady: (scope) => `Type an ordinance title for auto-search within ${scope}, or enter known before/after IDs directly.`,
